...
@Autonomous(name="BLUE_AUD_2+1_TRUSS", group="Auto")
public class Blue21Audience extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Pose2d startPose = new Pose2d(-40.0, 63.42, Math.toRadians(-90.0));
        drive.setPoseEstimate(startPose);

        Trajectory right = drive.trajectoryBuilder(startPose)
                .splineTo(new Vector2d(-45.99, 40.0), Math.toRadians(270.0))
                .build();

        Trajectory middle = drive.trajectoryBuilder(startPose)
                .splineTo(new Vector2d(-36.5, 35.0), Math.toRadians(270.0))
                .build();

        Trajectory left = drive.trajectoryBuilder(startPose)
                .splineTo(new Vector2d(-31.5, 39.5), Math.toRadians(270.0))
                .build();
        ...
        Trajectory rightatintake = drive.trajectoryBuilder(backup_right.end())
                .lineToLinearHeading(new Pose2d(-56.2, 41.0, Math.toRadians(25.00)))
                .build();
        ...
        Trajectory righttruss = drive.trajectoryBuilder(rightintakeback1.end())
                .splineTo(new Vector2d(-29.48, 57.0), Math.toRadians(0.00))
                .build();
        ...
        Trajectory middletruss = drive.trajectoryBuilder(middleintakeback1.end())
                .splineTo(new Vector2d(-29.48, 56.0), Math.toRadians(0.00))
                .build();
        ...
        Trajectory leftatintake = drive.trajectoryBuilder(backup_left.end())
                .lineToLinearHeading(new Pose2d(-55.0, 37.8, Math.toRadians(0.00)))
                .build();
        ...
        TrajectorySequence leftbackdrp = drive.trajectorySequenceBuilder(lefttruss.end())
                ...
                .splineTo(new Vector2d(42.52, 36.4), Math.toRadians(0.00))
                .build();
        ...
        TrajectorySequence leftundertruss = drive.trajectorySequenceBuilder(away_left.end())
                ...
                .splineTo(new Vector2d(12.0, 56.2), Math.PI)
                .splineTo(new Vector2d(-30.0, 56.2), Math.toRadians(180.0))
                .splineTo(new Vector2d(-54.5, 31.95), Math.toRadians(180.0))
                .build();
        ...
        TrajectorySequence left_backstage2drop = drive.trajectorySequenceBuilder(leftintakeback3.end())
                .splineTo(new Vector2d(-29.5, 53.0), Math.toRadians(0.00))
                .splineTo(new Vector2d(17.33, 54.0), Math.toRadians(0.00))
                .splineTo(new Vector2d(54.45, 45.54), Math.toRadians(-25.0))
                .build();
        ...
        TrajectorySequence rightundertruss = drive.trajectorySequenceBuilder(away_right.end())
                ...
                .splineTo(new Vector2d(12.0, 56.2), Math.PI)
                .splineTo(new Vector2d(-30.0, 56.2), Math.toRadians(180.0))
                .splineTo(new Vector2d(-56.2, 44.0), Math.toRadians(-135.0))
                .build();
        ...
        TrajectorySequence right_backstage2drop = drive.trajectorySequenceBuilder(rightintakeback3.end())
                .splineTo(new Vector2d(-29.5, 53.0), Math.toRadians(0.00))
                .splineTo(new Vector2d(17.33, 54.0), Math.toRadians(0.00))
                .splineTo(new Vector2d(54.0, 45.6), Math.toRadians(-25.0))
                .build();
        ...
        Trajectory middle_intakeforward3 = drive.trajectoryBuilder(middleundertruss.end())
                .back(2.45)
                .build();
        Trajectory middleintakeback3 = drive.trajectoryBuilder(middle_intakeforward3.end())
                .forward(7.0)
                .build();
        ...
        TrajectorySequence middle_backstage2drop = drive.trajectorySequenceBuilder(middleintakeback3.end())
                .splineTo(new Vector2d(-29.5, 53.0), Math.toRadians(0.00))
                .splineTo(new Vector2d(17.33, 54.0), Math.toRadians(0.00))
                .splineTo(new Vector2d(53.95, 45.6), Math.toRadians(-25.0))
                .build();
