...
//
//
//@Autonomous(name="BlueAud 2+3 Door", group="Auto")
//public class blueaudstagedoor extends LinearOpMode {
//
...
//        .lineToLinearHeading(new Pose2d(-51.23, 25, Math.toRadians(0.00)))
//        .back(.5)
//        .lineToLinearHeading(new Pose2d(-58.5,12, Math.toRadians(0)))
//        .build();
//        TrajectorySequence middle= drive.trajectorySequenceBuilder(startPose)
//        .lineToLinearHeading(new Pose2d(-50, 25, Math.toRadians(0.00)))
//        .lineToLinearHeading(new Pose2d(-58.5,12, Math.toRadians(0)))
//        .build();
//        TrajectorySequence left= drive.trajectorySequenceBuilder(startPose)
//        .lineToLinearHeading(new Pose2d(-31.99, 30, Math.toRadians(0)))
//        .lineToLinearHeading(new Pose2d(-58.5,12, Math.toRadians(0)))
//        .build();
//
//
