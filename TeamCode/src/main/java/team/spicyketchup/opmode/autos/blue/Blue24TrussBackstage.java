...
@Disabled
@Autonomous(name="Truss 2+4 Backstage", group="Auto")
public class Blue24TrussBackstage extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Trajectory right = drive.trajectoryBuilder(startPose)
            .splineTo(new Vector2d(24.2, 40.0), Math.toRadians(-90.00), SampleMecanumDrive.getVelocityConstraint(50, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
            .build();
        Trajectory middle = drive.trajectoryBuilder(startPose)
            .splineTo(new Vector2d(13.0, 35.0), Math.toRadians(-90.00), SampleMecanumDrive.getVelocityConstraint(50, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
            .build();
        Trajectory left = drive.trajectoryBuilder(startPose)
            .splineTo(new Vector2d(10.0, 36.0), Math.toRadians(-140.00), SampleMecanumDrive.getVelocityConstraint(50, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
            .build();
        ...
        Trajectory middledropyellow = drive.trajectoryBuilder(middleback.end())
            ...
            .splineToConstantHeading(new Vector2d(50.0, 33.83), Math.toRadians(0.00))
            .build();
        Trajectory away_middle = drive.trajectoryBuilder(middledropyellow.end())
            .back(5.7)
            .build();

        Trajectory leftback = drive.trajectoryBuilder(left.end())
            .back(15.0)
            .build();
        Trajectory leftdropyellow =
           drive.trajectoryBuilder(leftback.end()) // .splineTo(new Vector2d(13, -35), Math.toRadians(0.00))
                .splineTo(new Vector2d(42.8, 25.0), Math.toRadians(0.00))
                .splineToConstantHeading(new Vector2d(50.1, 25.0), Math.toRadians(0.00))
                .build();
        ...
        Trajectory rightdropyellow = drive.trajectoryBuilder(rightback.end())
            .splineTo(new Vector2d(42.8, 40.0), Math.toRadians(0.00))
            .splineToConstantHeading(new Vector2d(50.0, 40.0), Math.toRadians(0.00))
            .build();
