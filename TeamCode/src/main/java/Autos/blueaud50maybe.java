...
public class blueaud50maybe extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Trajectory left = drive.trajectoryBuilder(startPose)
                .splineTo(new Vector2d(-48, 39.5), Math.toRadians(-90))
                .build();

        Trajectory middle = drive.trajectoryBuilder(startPose)
                .splineTo(new Vector2d(-36.5, 35.1), Math.toRadians(-90))
                .build();


        Trajectory right = drive.trajectoryBuilder(startPose)
                .splineTo(new Vector2d(-35.5, 37), Math.toRadians(330))
                .build();
        ...
        Trajectory leftatintake = drive.trajectoryBuilder(backup_left.end())
                .lineToLinearHeading(new Pose2d(-56.2, 41.5, Math.toRadians(385)))
                .build();

        Trajectory left_intakeforward = drive.trajectoryBuilder(leftatintake.end())
                .back(5.25, SampleMecanumDrive.getVelocityConstraint(15, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
        ...
        TrajectorySequence leftbackdrp= drive.trajectorySequenceBuilder(lefttruss.end())
                .splineToConstantHeading(new Vector2d(21.44, 57.9), Math.toRadians(0.00))
                .splineTo(new Vector2d(42.52, 28.25), Math.toRadians(0.00))
                //.splineToConstantHeading(new Vector2d(21.44, -57.9), Math.toRadians(0.00))
                //  .splineTo(new Vector2d(42.52, -31.44), Math.toRadians(0.00))
                .build();
...
//                .build();
        ...
        Trajectory middleatintake = drive.trajectoryBuilder(backup_middle.end())
                .lineToLinearHeading(new Pose2d(-56.2, 42.85, Math.toRadians(385)))
                .build();

        Trajectory middle_intakeforward = drive.trajectoryBuilder(middleatintake.end())
                .back(4.9, SampleMecanumDrive.getVelocityConstraint(15, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .build();
...
//
        ...
        Trajectory rightatintake = drive.trajectoryBuilder(backup_right.end())
                .lineToLinearHeading(new Pose2d(-56.2, 39.89, Math.toRadians(385)))
                .build();

        Trajectory right_intakeforward = drive.trajectoryBuilder(rightatintake.end())
                .back(5.45, SampleMecanumDrive.getVelocityConstraint(15, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .build();
        ...
        TrajectorySequence rightbackdrp= drive.trajectorySequenceBuilder(righttruss.end())
                .splineToConstantHeading(new Vector2d(21.44, 57.9), Math.toRadians(0.00))
                .splineTo(new Vector2d(42.52, 41), Math.toRadians(0.00))
                //.splineToConstantHeading(new Vector2d(21.44, -57.9), Math.toRadians(0.00))
                //  .splineTo(new Vector2d(42.52, -31.44), Math.toRadians(0.00))
                .build();
