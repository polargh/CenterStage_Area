...
public class Yellowpixelpipe extends OpenCvPipeline {
    ...
    private Hardware.Yellowpixelpipe.Location location = Hardware.Yellowpixelpipe.Location.LEFT;
...
//        Scalar highHSV = new Scalar(175, 255, 72);
        ...
        if (stoneLeft) {
            location = Hardware.Yellowpixelpipe.Location.LEFT;
            telemetry.addData("Cube Location", "left");
        }
        else  {
            location = Hardware.Yellowpixelpipe.Location.RIGHT;
...
//        }
        ...
        Imgproc.rectangle(mat, LEFT_ROI, location == Hardware.Yellowpixelpipe.Location.LEFT? green:red);//middle
        // Imgproc.rectangle(mat, RIGHT_ROI, location == Hardware.yellowPixelBoxPipeline.Location.RIGHT? green:red);//right

        return mat;
    }

    public Hardware.Yellowpixelpipe.Location getLocation() {
        return location;
    }
